...
def _set_profile_window_props(profile):
    ...
    # VIP = qualquer perfil adulto ativo (adapte à sua lógica real de VIP)
    win.setProperty('cineroom_is_vip',              '0' if profile.get('is_kids') else '1')
...
class ProfileManager:
    ...
    def select_avatar(self, is_kids=False):
        """Wall visual de avatares em grid (SelectAvatar.xml)."""
